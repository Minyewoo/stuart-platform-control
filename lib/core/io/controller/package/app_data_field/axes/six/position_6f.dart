...
class Position6i implements ByteSequence {
  final Iterable<int> _bytes;
  ///
  const Position6i._(this._bytes) : assert(_bytes.length==24);
  ///
  const factory Position6i.fromIterable(Iterable<int> bytes) = Position6i._;
  ///
  factory Position6i.fromValue({
    required int x,
    required int y,
    required int z,
    required int u,
